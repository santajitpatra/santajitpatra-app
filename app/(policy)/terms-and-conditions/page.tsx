    ...
    <>
      ...
      <div className="p-16">
        ...
        <p>
          ...
          in full. Do not continue to use Santajit patra&apos;s website if you
        ...
        <h2>Cookies</h2>
        <p>
          We employ the use of cookies. By using Santajit patra&apos;s website
          you consent to the use of cookies in accordance with Santajit
          patra&apos;s privacy policy.
        </p>
        <p>
        ...
        <h2>License</h2>
        <p>
          Unless otherwise stated, Santajit patra and/or it&apos;s licensors own
          the intellectual property rights for all material on Santajit patra.
          All intellectual property rights are reserved. You may view and/or
          print pages from santajitpatra.vercel.app/ for your own personal use
          subject to restrictions set in these terms of service.
        </p>
        <p>You must not:</p>
        <ol>
          <li>Republish material from santajitpatra.vercel.app/</li>
          <li>
            Sell, rent or sub-license material from santajitpatra.vercel.app/
          </li>
          <li>
        ...
        <ol>
          ...
          <li>
            ...
            (&apos;Comments&apos;) in areas of the website. Santajit patra does
            ...
            opinions of Santajit patra, its agents or affiliates. Comments
            reflect the view and opinion of the person who posts such view or
            opinion. To the extent permitted by applicable laws Santajit patra
            shall not be responsible or liable for the Comments or for any loss
        ...
        <p>
          No use of Santajit patra&apos;s logo or other artwork will be allowed
