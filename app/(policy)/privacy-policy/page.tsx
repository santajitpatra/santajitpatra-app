  ...
  return (
    <>
      ...
      <div className="p-16">
        ...
        <p>
          It is Santajit patra&quot;s policy to respect your privacy regarding
          any information we may collect while operating our website. This
          Privacy Policy applies to{" "}
          <a href="https://santajitpatra.vercel.app/">
            {" "}
            santajitpatra.vercel.app/
          </a>{" "}
          (hereinafter, &quot;us&quot;, &quot;we&quot;, or
          &quot;santajitpatra.vercel.app/&quot;). We respect your privacy and
        ...
        <p>
          ...
          visitor request. Santajit patra&apos;s purpose in collecting
          non-personally identifying information is to better understand how
          Santajit patra&apos;s visitors use its website. From time to time,
          Santajit patra may release non-personally-identifying information in
        ...
        <p>
          ...
          and for users leaving comments on https://santajitpatra.vercel.app/
        ...
        <p>
          Certain visitors to Santajit patra&apos;s websites choose to interact
          with Santajit patra in ways that require Santajit patra to gather
          ...
          https://santajitpatra.vercel.app/ to provide a username and email
          address.
        </p>
        <p>
          <a href="#tableofcontents">Back to table of contents</a>
        ...
        <p>
          ...
          on someone&apos;s past visits. Of course, any data collected will be
        ...
        <p>
          ...
          information in order to process it on Santajit patra&apos;s behalf or
          to provide services available at Santajit patra&apos;s website, and
          ...
          outside of your home country; by using Santajit patra&apos;s website,
          you consent to the transfer of such information to them. Santajit
          patra will not rent or sell potentially personally-identifying and
          ...
          above, Santajit patra discloses potentially personally-identifying and
          personally-identifying information only in response to a subpoena,
          court order or other governmental request, or when Santajit patra
          believes in good faith that disclosure is reasonably necessary to
          protect the property or rights of Santajit patra, third parties or the
          public at large.
        </p>
        <p>
          If you are a registered user of https://santajitpatra.vercel.app/ and
          ...
          just keep you up to date with what&apos;s going on with Santajit patra
          and our products. We primarily use our blog to communicate this type
          of information, so we expect to keep this type of email to a minimum.
          ...
          support other users. Santajit patra takes all measures reasonably
        ...
        <p>
          ...
          to the website each time the visitor returns. Santajit patra uses
          cookies to help Santajit patra identify and track visitors, their
          usage of https://santajitpatra.vercel.app/, and their website access
          ...
          before using Santajit patra&apos;s websites, with the drawback that
          certain features of Santajit patra&apos;s websites may not function
          properly without the aid of cookies.
        </p>
        <p>
          By continuing to navigate our website without changing your cookie
          settings, you hereby acknowledge and agree to Santajit patra&apos;s
          use of cookies.
        </p>
        <p>
          <a href="#tableofcontents">Back to table of contents</a>
        ...
        <p>
          ...
          Santajit patra&apos;s services or products, are asked to provide
          ...
          case, Santajit patra collects such information only insofar as is
          necessary or appropriate to fulfill the purpose of the visitor&apos;s
          interaction with Santajit patra. Santajit patra does not disclose
        ...
        <p>
          ...
          change its Privacy Policy from time to time, and in Santajit
          patra&apos;s sole discretion. Santajit patra encourages visitors to
